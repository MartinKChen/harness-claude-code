...
# tip the reviewer is asked to review. Prints the worktree path on success.
#
# The reviewer is read-only on code, so this script does NOT rebase onto main.
# It only checks the slice branch out at the current remote head.
#
# Usage:
