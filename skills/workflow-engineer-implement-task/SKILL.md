...
- For each **persistence entity** the change reads/writes/migrates, read `docs/product-requirement-document/<feature-name>/data-model/<entity>.md`.
- For each **API resource** the change exposes or consumes, read `docs/product-requirement-document/<feature-name>/api-contract/<entity>.md`.
