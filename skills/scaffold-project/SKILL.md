...
- **Scaffold is feature-agnostic.** Never read `docs/product-requirement-document/<feature>/api-contract/` or `docs/product-requirement-document/<feature>/data-model/`. The only doc surface this skill consults is `docs/ADRs/`.
