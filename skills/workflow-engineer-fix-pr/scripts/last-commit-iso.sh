...
# remote slice branch (the PR's head ref). Used as the cutoff for filtering
# PR-issue comments — only comments created strictly after this timestamp
# are unaddressed user directives that need to apply to this fix pass.
#
