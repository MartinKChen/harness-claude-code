...
| `create-feature-issues` | Decomposes a locked-in feature's PRD into thin vertical-slice GitHub issues with EARS + Gherkin acceptance criteria (one `kind:feature` issue per slice + linked branch). The feature member of the three issue-creation skills. |
